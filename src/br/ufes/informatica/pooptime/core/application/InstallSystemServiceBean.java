...
import br.ufes.informatica.pooptime.core.persistence.MarvinConfigurationDAO;
...
public class InstallSystemServiceBean implements InstallSystemService {
	...
	/**
	 * @see br.ufes.informatica.pooptime.core.application.InstallSystemService#installSystem(br.ufes.informatica.pooptime.core.domain.MarvinConfiguration,
